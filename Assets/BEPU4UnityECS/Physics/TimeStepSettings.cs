namespace Unity.BEPUphysics
{
    ...
    ///</summary>
    public struct TimeStepSettings
    {
        /// <summary>
        ...
        public TimeStepSettings(int maxTimeStepsPerFrame = 3, float timeStepDuration = 1f/60)
        {
            MaximumTimeStepsPerFrame = maxTimeStepsPerFrame;
